                    ...
                    if (curToken.Length() <= 6 && scmpi_n(curToken, TEXT("float"), 5) == 0)
                    {
                        ...
                        else
                        {
                            ...
                            case '3':
                                ...
                                break; //todo: check this some time
                            case '4':
                                inputElement.Format = DXGI_FORMAT_R32G32B32A32_FLOAT;
                                break;
                            }
...
BOOL ShaderProcessor::AddState(SamplerInfo &info, String &stateName, String &stateVal)
{
    if (scmpi_n(stateName, TEXT("Address"), 7) == 0)
    {
        ...
        case 2:
            ...
            break;
        default:
            CrashError(TEXT("Invalid shader address type %d"), type);
        }
    ...
    else if (stateName.CompareI(TEXT("BorderColor")))
    {
        if (stateVal[0] == '{')
        {
            ...
            info.borderColor.P4.x = (float)tstof(curToken);
            ...
            info.borderColor.P4.y = (float)tstof(curToken);
            ...
            info.borderColor.P4.z = (float)tstof(curToken);
            ...
            info.borderColor.P4.w = (float)tstof(curToken);
